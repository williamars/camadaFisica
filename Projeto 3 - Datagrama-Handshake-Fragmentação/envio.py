        ...
        while not send_all_packages:
            ...
            if see_error(ans_head, ans_eop):
                ...
                if transform_to_int(ans_head[4:5]) == 1:
                    ...
                    print("O pacote para reenviar é o:", new)
                    number_package = new
                    # print("O payload que enviarei é entre {} e {}". format(index_data1, index_data1+114))

                else:
                    print("Enviou certo. Próximo\n")
                    index_data1 += size_payload
                    # number_package = random.choice(list(range(0, packages)))
                    number_package = transform_to_int(ans_head[5:6]) + 0
